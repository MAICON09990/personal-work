    ...
    stages {
        ...
        stage('4.Terraform Deploy') {              
            steps { 
                ...
                //sh "aws eks --region us-east-2 update-kubeconfig --name ust-cluster && export KUBE_CONFIG_PATH=~/.kube/config"
                //sh "AWS_REGION=us-east-2 terraform ${params.deploy_choice} --auto-approve"
            }
                }
        stage ('5. Email Notification') {
            steps {
               mail bcc: 'jordtebong1996@gmail.com', body: '''Terraform deployment is completed.
               Let me know if the changes look okay.
               Thanks,
               ust team 2,
              +234 818 236 7844''', cc: 'jordtebong1996@gmail.com', from: '', replyTo: '', subject: 'Terraform Infra deployment completed!!!', to: 'lawrencetech2013@gmail.com'
